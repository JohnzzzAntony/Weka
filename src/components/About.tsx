  ...
  return (
    <section id="about" className="relative py-32 px-6 bg-[#0f171c]">
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 md:gap-20 items-center">
        ...
        >
          <div className="relative aspect-square rounded-2xl overflow-hidden glass-panel p-2 md:p-4">
            <Image
          ...
          {/* Badge */}
          <div className="absolute -bottom-4 -right-2 md:-bottom-6 md:-right-6 glass-panel p-4 md:p-8 rounded-2xl border border-white/20">
            <div className="text-2xl md:text-4xl font-black text-safety-orange">30+</div>
            <div className="text-[8px] md:text-xs font-bold text-white uppercase tracking-widest mt-1">Years of<br />Expertise</div>
          </div>
        </motion.div>
